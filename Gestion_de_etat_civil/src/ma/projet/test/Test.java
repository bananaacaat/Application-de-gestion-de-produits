...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Homme h1 = new Homme("SAFI", "SAID", "123478954", "aaaa", new Date(1984 - 1900, 4, 3));
        Homme h2 = new Homme("hnome 1", "yprenome 1", "123478954", "aaaa", new Date(1994 - 1900, 4, 3));
        Homme h3 = new Homme("hnome 2", "yprenome 2", "123478954", "bbbb", new Date(1987 - 1900, 4, 3));
        Homme h4 = new Homme("hnome 3", "yprenome 3", "123478954", "aaaa", new Date(1999 - 1900, 4, 3));
        Homme h5 = new Homme("hnome 4", "yprenome 4", "123478954", "bbbb", new Date(1982 - 1900, 4, 3));
        Femme f1 =  new Femme("RAMI", "SALIMA", "123478954", "dddd", new Date(1987 - 1900, 4, 3));
        Femme f2 = new Femme("AMAL", "ALI", "123478954", "cccc", new Date(1984 - 1900, 8, 13));
        Femme f3 =  new Femme("WAFA", "ALAOUI", "123478954", "dddd", new Date(1988 - 1900, 4, 3));
        Femme f4 = new Femme("KARIMA", "ALAMI", "123478954", "cccc", new Date(1987 - 1900, 2, 3));
        Femme f5 =  new Femme("fnome 1", "fprenome 1", "123478954", "dddd", new Date(1992 - 1900, 1, 5));
        Femme f6 = new Femme("fnome 2", "fprenome 2", "123478954", "cccc", new Date(1995 - 1900, 4, 3));
        Femme f7 =  new Femme("fnome 3", "fprenome 3", "123478954", "dddd", new Date(1980 - 1900, 4, 3));
        Femme f8 = new Femme("fnome 4", "fprenome 4", "123478954", "cccc", new Date(1979 - 1900, 4, 3));
        Femme f9 =  new Femme("fnome 5", "fprenome 5", "123478954", "dddd", new Date(1988 - 1900, 11, 3));
        Femme f10 = new Femme("fnome 6", "fprenome 6", "123478954", "cccc", new Date(1984 - 1900, 6, 3));

...
public class Test {
    public static void main(String[] args) {
        ...
        // cree les employes
        es.create(new Employe("nom 1", "prenom 1", "9854384448"));
        es.create(new Employe("nom 2", "prenom 2", "7853244525"));
        es.create(new Employe("nom 3", "prenom 3", "1187896234"));
        es.create(new Employe("nom 4", "prenom 4", "7847426878"));
        es.create(new Employe("nom 5", "prenom 5", "7701993177"));
        ...
        // cree les projets
        Projet p_1 = new Projet("projet 1", new Date(2023- 1800, 0, 1), new Date(2024- 1900, 0, 1), es.getById(1));
        Projet p_2 = new Projet("projet 2", new Date(2023- 1800, 5, 1), new Date(2027- 1900, 9, 1), es.getById(4));
        Projet p_3 = new Projet("projet 3", new Date(2017- 1800, 0, 1), new Date(2021- 1900, 8, 1), es.getById(2));
        Projet p_4 = new Projet("projet 4", new Date(2023- 1800, 2, 1), new Date(2023- 1900, 8, 1), es.getById(3));
        Projet p_5 = new Projet("Gestion de stock", new Date(2021- 81800, 7, 15), new Date(2021- 1900, 10, 18), es.getById(1));
        Projet p_6 = new Projet("projet 6", new Date(2023- 1800, 10, 11), new Date(2026- 1900, 10, 11), es.getById(3));
